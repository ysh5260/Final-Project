...
<div class="row">
	<div class="card">
		...
		<form  style="display : ${display}" id="excelUploadForm" name="excelUploadForm" enctype="multipart/form-data"	method="post" action="excelUpload" class="d-flex align-items-center">
			<div class="form-group mr-2" style="padding-right:10px;">
		...
		<div class="row" id="keyword" style="margin-top: 20px; margin-bottom: 20px;"  style="display: ${display}">
					...
					<c:if test="${status eq 's' }">
						...
						<div class="col-md-1 mb-1">
							<button type="button" class="btn btn-md light btn-primary"  style="margin-top:25px;padding-top: 10px;padding-bottom: 10px;" id="stuList">검색</button>
						</div>
					</c:if>
					<c:if test="${status eq 'p' }">
						<div class="col-md-2 mb-1">
						...
						<div class="col-md-1 mb-1">
							<button type="button" class="btn btn-md light btn-primary"  style="margin-top:25px;padding-top: 10px;padding-bottom: 10px;"  id="proList">검색</button>
						</div>
					</c:if>
					<c:if test="${status eq 'e' }">
						<div class="col-md-2 mb-1">
						...
						<div class="col-md-1 mb-1">
							<button type="button" class="btn btn-md light btn-primary" style="margin-top:25px;padding-top: 10px;padding-bottom: 10px;"  id="empList">검색</button>
						</div>	
					</c:if>
				</div>
